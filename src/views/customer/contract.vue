        ...
        return {
            ...
            tableHeader: [{
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        return h(
                            "span", params.row.strartTime && (params.row.strartTime).substr(0,10)
                        );
                    }
                },
                {
                    ...
                    render: (h, params) => {
                        return h(
                            "span", params.row.endTime && (params.row.endTime).substr(0,10)
                        );
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        return h(
                            "router-link", {
                                attrs: {
                                    to: "/customer/contract/details?id="+params.row.id+'&cname='+params.row.companyName
                                }
                            },
                            "详情"
                        );
