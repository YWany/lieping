<template>
    <div class="jobDoingDetails">
        <div class='currentNav'>当前位置: 客户 >
            ...
            <router-link :to="'/customer/jobDoing/job?jodId='+jodId">职位运作</router-link> > 
            职位详情
        </div>
        <div class="jobtile">
            <div class="left-box">
                    ...
                    <div class="resume-header">
                        <div class="re-top">
                            ...
                            <div class="re-handle">
                                ...
                                <Button class="but2" type="primary" @click="$router.push('/customer/jobDoing/recommend?jodId='+jodId)">立即推荐</Button>
                            </div>
                        </div>
                        <div class="re-up">
                            <div class="position">
