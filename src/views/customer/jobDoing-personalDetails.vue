    ...
    <div class="content">
      ...
      <div class="content-right">
        ...
        <p>Content of dialog</p>
           ...
           <ul class="re-list">
             <li>
               <span>2018-05-01  于新华：</span>
               说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话说的话
...
.content {
  ...
  .content-right {
    ...
    .handle {
      ...
      .bu1 {
        background: url(../../assets/images/give.png) no-repeat center 0.7rem;
        background-size: 20%;
      }
      .bu2 {
        background: url(../../assets/images/share.png) no-repeat center 0.7rem;
        background-size: 20%;
      }
      .bu3 {
        background: url(../../assets/images/add.png) no-repeat center 0.7rem;
        background-size: 20%;
      }
      .bu4 {
        background: url(../../assets/images/daochu.png) no-repeat center 0.7rem;
        background-size: 20%;
      }
      .bu5 {
        background: url(../../assets/images/queren.png) no-repeat center 0.7rem;
        background-size: 20%;
      }
      .bu6 {
        background: url(../../assets/images/jubao.png) no-repeat center 0.7rem;
        background-size: 20%;
      }
    }
    .remark {
