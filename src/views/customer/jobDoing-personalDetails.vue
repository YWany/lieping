...
<div class="personalDetails">
	<div class='currentNav'>当前位置: <router-link to='/customer/jobDoing'>职位进展</router-link> > <router-link :to='lastRouter'>职位运作</router-link> > 候选人详情</div>
	<div class="detailsWrap">
						...
						<div class="jl-c">
							...
							<div class="header-c">
								...
								<div class="header-name">
									<span class="education"><Icon type="briefcase"></Icon>本科学历</span>
									<span class="experience"><Icon type="briefcase"></Icon>12年经验</span>
									<span class="site"><Icon type="briefcase"></Icon>杭州</span>
									<span class="university"><Icon type="briefcase"></Icon>浙江教育学院</span>
									<span class="purpose"><Icon type="briefcase"></Icon>我怼现在工作表满意，考虑跳槽</span>
								</div>
							...
							<div class="purpose-c">
								...
								<div class="purpose-name">
									<span class="education"><Icon type="briefcase"></Icon>杭州</span>
									<span class="experience"><Icon type="briefcase"></Icon>10k-20k</span>
								</div>
							</div>
		...
		<div class="content-right">
			...
			<div class="tickling">
				...
				<ul class="ti-list">
					<li>
						<span>杭州明白网络科技有限公司 <b>2018-05-01</b></span>
...
.personalDetails {
	...
	.content-right {
		...
		.handle {
			...
			.bu1 {
				background: url(../../assets/images/give.png) no-repeat center 8px;
				background-size: 18%;
			}
			.bu2 {
				background: url(../../assets/images/share.png) no-repeat center 8px;
				background-size: 18%;
			}
			.bu3 {
				background: url(../../assets/images/add.png) no-repeat center 8px;
				background-size: 18%;
			}
			.bu4 {
				background: url(../../assets/images/daochu.png) no-repeat center 8px;
				background-size: 18%;
			}
			.bu5 {
				background: url(../../assets/images/queren.png) no-repeat center 8px;
				background-size: 18%;
			}
			.bu6 {
				background: url(../../assets/images/jubao.png) no-repeat center 8px;
				background-size: 18%;
			}
		}
		.remark {
