<template>
    <div class="jobDoing">
        <div class='currentNav'>当前位置: 职位进展 
            <ul class="nums fr">
                <li>所有项目<span>(740)</span></li>
                <li>未开始<span>(45)</span></li>
                <li>进行中<span>(22)</span></li>
                <li>录用<span>(0)</span></li>
                <li>上岗<span>(15)</span></li>
                <li>成功项目<span>(0)</span></li>
                <li>暂换项目<span>(0)</span></li>
                <li>终止项目<span>(0)</span></li>
                <li>失效项目<span>(0)</span></li>
            </ul>
        </div>
        <form class="searches">
            <div class="search">
